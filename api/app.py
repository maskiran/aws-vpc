...
app.register_blueprint(resources.vpc.app, url_prefix='/vpcs')
app.register_blueprint(resources.subnet.app, url_prefix='/subnets')
app.register_blueprint(resources.security_group.app, url_prefix='/security-groups')
